...
SAVE_DIR = Path('../save/kg_fp_fold5_12'); SAVE_DIR.mkdir(parents=True, exist_ok=True)
...
def per_receptor_metrics(y_true, y_prob):
    ...
    return macro, {'Receptor': RECEPTORS, 'BAC': col_bac, 'F1': col_f1, 'AUC': col_auc}
